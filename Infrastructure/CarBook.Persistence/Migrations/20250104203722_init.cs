        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendDatae = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarFeautureId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarId = table.Column<int>(type: "int", nullable: false),
                    FeatureId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarsFeautures", x => x.CarFeautureId);
                    table.ForeignKey(
                        name: "FK_CarsFeautures_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarsFeautures_Features_FeatureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarsFeautures_CarId",
                table: "CarsFeautures",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarsFeautures_FeatureId",
                table: "CarsFeautures",
                column: "FeatureId");
        }
